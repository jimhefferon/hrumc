...
\sessionhead{One}
\session{Applied Mathematics Ia}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{phaneuf} % 26
\at{\Ib}{ratliff} % 12
\at{\Ic}{soper} % 13

\session{Applied Mathematics Ib}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{desilva} % 22
\at{\Ib}{lerma} % 17
\at{\Ic}{vandermause} % 30

\session{Abstract Algebra I}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{peterson} % 1  
\at{\Ib}{young} % 6
\at{\Ic}{mchugh} % 5

\session{Analysis}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{vees} % 9
\at{\Ib}{morfe} % 7
\at{\Ic}{jauregul} % 8

\session{Combinatorics I}{STE 107}{Fred McGuilicuddy}
\at{\Ia}{kenney} % 38 
\at{\Ib}{boyadzhiyska} % 41 
\at{\Ic}{trenk} % 40

\session{Differential Equations I}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{zachos} % 46
\at{\Ib}{bassette} % 51 
\at{\Ic}{mclaren} % 52

\session{Geometry I}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{ramrath} % 58
\at{\Ib}{martinez1} % 60
\at{\Ic}{johnson} % 57

\session{Linear Algebra}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{warzer} % 77
\at{\IIIb}{ogle} % 76
\at{\IIIc}{reams} % 75

\session{Number Theory I}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{jia} % 91
\at{\Ib}{isham} % 86 
\at{\Ic}{chong} % 92

\session{Paradoxes}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{harding} % 28
\at{\Ib}{daniere} % 117
\at{\Ic}{quenell} % 39

\session{Statistics Ia}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{schuckers} % 100 
\at{\Ib}{west} % 96
\at{\Ic}{trono} % 112

\session{Statistics Ib}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{okeeffe} % 109
\at{\Ib}{pan} % 113
\at{\Ic}{roque} % 25

\session{Topology I}{STE 106}{Fred McGuilicuddy}
\at{\Ia}{daley} % 115
\at{\Ib}{gall} % 116
\at{\Ic}{dragon} % 118
...
\session{Applied Math IIa}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{ryzin} % 11
\at{\IIb}{hodge} % 20
\at{\IIc}{westland1} %10
\at{\IId}{afinogenov} % 94

\session{Applied Math IIb}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{kramer} % 23
\at{\IIb}{vrimoet} % 24
\at{\IIc}{holmes} % 27
\at{\IId}{kadas} % 15

\session{Combinatorics II}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{vella} % 36
\at{\IIb}{bryant} % 31
\at{\IIc}{lane} % 32
\at{\IId}{halden} % 33

\session{Computer Science}{STE 106}{Fred McGuilicuddy}
\at{\IIa}{zwicker} % 45
\at{\IIb}{claassen} % 42
\at{\IIc}{orzell} % 43
\at{\IId}{barrett} % 44

\session{Differential Equations II}{STE 107}{Fred McGuilicuddy}
\at{\IIb}{klein} % 49
\at{\IIa}{buck} % 47
\at{\IIc}{li} % 54
% \at{\IId}{}

\session{Graph Theory}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{holbrooks} % 66
\at{\IIb}{howard} % 67
\at{\IIc}{tremblay} % 65
\at{\IId}{whelan} % 64

\session{Mathematics Education I}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{raymond} % 79 
\at{\IIb}{bouchard} % 82
\at{\IIc}{tironi} % 81
\at{\IId}{czupryna} % 83

\session{Number Theory II}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{paight} % 87 
\at{\IIb}{landfair} % 88
\at{\IIc}{northshield} % 89
\at{\IId}{ratliff1} % 93

\session{Statistics IIa}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{escobar} % 101
\at{\IIb}{hurlbut} % 102
\at{\IIc}{amerman} % 104
\at{\IId}{martinez} % 108

\session{Statistics IIb}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{darrow} % 99
\at{\IIb}{markiewicz} % 106
\at{\IIc}{mcgraw} % 103
\at{\IId}{cameron} % 111

\session{Topology and Graph Theory}{STE 107}{Fred McGuilicuddy}
\at{\IIa}{luangrath} % 68 
\at{\IIb}{mcintyre} % 119
\at{\IIc}{chernov} % 114
% \at{\IId}{} %

\session{Abstract Algebra II}{STE 106}{Fred McGuilicuddy}
\at{\IIa}{mchugh} % 2
\at{\IIb}{dever} % 4
\at{\IIc}{gibson} % 62

\session{Geometry II}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{bania} % 63 
\at{\IIIb}{hulbregtse} % 59
\at{\IIIc}{ferlini} % 61
...
\session{Applied Math IIIa}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{field} % 19
\at{\IIIb}{curtin} % 18
\at{\IIIc}{turner} % 14

\session{Applied Math IIIb}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{wood} % 16
\at{\IIIb}{johnston} % 21
% \at{\IIIc}{}

\session{Combinatorics III}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{barde}  % 34
\at{\IIIb}{armstrong}  % 35
\at{\IIIc}{hernandez} % 37

\session{Knot Theory}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{lowrance} % 74
\at{\IIIb}{bennett} % 73
\at{\IIIc}{westland} % 72

\session{Differential Equations III}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{lefevre} % 48
\at{\IIIb}{oitsik} % 50
\at{\IIIc}{bennett} % 53

\session{Fractals and Chaos}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{healy} % 55
\at{\IIIb}{ostby} % 56
% \at{\IIIc}{}

\session{History of Mathematics}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{hemingway} % 71
\at{\IIIb}{marinoff} % 69
\at{\IIIc}{gingrich} % 70

\session{Mathematics Education II}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{blue} % 78
\at{\IIIb}{stevens} % 80
% \at{\IIIc}{}

\session{Number Theory III}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{wyler} % 85
\at{\IIIb}{covey} % 90
\at{\IIIc}{nasser} % 84

\session{Probability and Statistics}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{bianco} % 95
\at{\IIIb}{mao} % 107
\at{\IIIc}{fredericks} % 105

\session{Statistics III}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{qi} % 98 
\at{\IIIb}{liu} % 97
\at{\IIIc}{davis} % 110

\session{Tropical Mathematics}{STE 106}{Fred McGuilicuddy}
\at{\IIIa}{cheverie} % 3
\at{\IIIb}{hamelin} % 29
% \at{\IIIc}{} % boris
