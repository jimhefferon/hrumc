...
\fullprogram{http://joshua.smcvt.edu/hrumc/hrumc2016full.pdf}
\vspace*{4ex}
\begin{help}
...
\sessionhead{One}
\session{Abstract Algebra I}{JEM 380}{To be announced}
\at{\Ia}{peterson} % 1  
\at{\Ib}{young} % 6
\at{\Ic}{mchugh} % 5

\session{Analysis}{JEM 389}{To be announced}
\at{\Ia}{vees} % 9
\at{\Ib}{morfe} % 7
\at{\Ic}{jauregul} % 8

\session{Applied Mathematics Ia}{JEM 378}{To be announced}
\at{\Ia}{phaneuf} % 26
\at{\Ib}{ratliff} % 12
\at{\Ic}{soper} % 13

\session{Applied Mathematics Ib}{JEM 166}{To be announced}
\at{\Ia}{desilva} % 22
\at{\Ib}{lerma} % 17
\at{\Ic}{vandermause} % 30

\session{Combinatorics I}{JEM 364}{To be announced}
\at{\Ia}{kenney} % 38 
...
\session{Geometry I}{JEM 281}{To be announced}
\at{\Ia}{ramrath} % 58
\at{\Ib}{johnson} % 57
\at{\Ic}{martinez1} % 60

\session{Linear Algebra}{JEM 377}{To be announced}
\at{\IIIa}{warzer} % 77
\at{\IIIb}{ogle} % 76
\at{\IIIc}{reams} % 75

\session{Number Theory I}{JEM 168}{To be announced}
\at{\Ia}{jia} % 91
\at{\Ib}{isham} % 86 
\at{\Ic}{chong} % 92

\session{Paradoxes}{JEM 375}{To be announced}
\at{\Ia}{harding} % 28
\at{\Ib}{daniere} % 117
\at{\Ic}{quenell} % 39

\session{Statistics Ia}{STE 104}{To be announced}
\at{\Ia}{schuckers} % 100 
\at{\Ib}{west} % 96
\at{\Ic}{trono} % 112

\session{Statistics Ib}{STE 102}{To be announced}
\at{\Ia}{okeeffe} % 109
\at{\Ib}{pan} % 113
\at{\Ic}{roque} % 25

\session{Topology}{JEM 373}{To be announced}
\at{\Ia}{daley} % 115
\at{\Ib}{gall} % 116
\at{\Ic}{dragon} % 118
...
\session{Abstract Algebra II}{JEM 373}{To be announced}
\at{\IIa}{mchugh} % 2
\at{\IIb}{dever} % 4
\at{\IIc}{gibson} % 62

\session{Applied Math IIa}{JEM 378}{To be announced}
\at{\IIa}{ryzin} % 11
\at{\IIb}{hodge} % 20
\at{\IIc}{westland1} %10
\at{\IId}{afinogenov} % 94

\session{Applied Math IIb}{JEM 166}{To be announced}
\at{\IIa}{kramer} % 23
\at{\IIb}{vrimoet} % 24
\at{\IIc}{holmes} % 27
\at{\IId}{kadas} % 15

\session{Combinatorics II}{JEM 364}{To be announced}
\at{\IIa}{vella} % 36
\at{\IIb}{bryant} % 31
\at{\IIc}{lane} % 32
\at{\IId}{halden} % 33

\session{Computer Science}{JEM 389}{To be announced}
\at{\IIa}{zwicker} % 45
\at{\IIb}{claassen} % 42
\at{\IIc}{orzell} % 43
\at{\IId}{barrett} % 44

\session{Differential Equations II}{JEM 362}{To be announced}
\at{\IIb}{klein} % 49
\at{\IIa}{buck} % 47
\at{\IIc}{li} % 54
% \at{\IId}{}

\session{Geometry II}{JEM 281}{To be announced}
\at{\IIa}{bania} % 63 
\at{\IIb}{hulbregtse} % 59
\at{\IIc}{ferlini} % 61

\session{Graph Theory}{JEM 380}{To be announced}
\at{\IIa}{holbrooks} % 66
\at{\IIb}{howard} % 67
\at{\IIc}{tremblay} % 65
\at{\IId}{whelan} % 64

\session{Graph Theory and Topology}{JEM 377}{To be announced}
\at{\IIa}{luangrath} % 68 
\at{\IIb}{mcintyre} % 119
\at{\IIc}{chernov} % 114
% \at{\IId}{} %

\session{Mathematics Education I}{JEM 168}{To be announced}
\at{\IIa}{raymond} % 79 
\at{\IIb}{bouchard} % 82
\at{\IIc}{tironi} % 81
\at{\IId}{czupryna} % 83

\session{Number Theory II}{JEM 375}{To be announced}
\at{\IIa}{paight} % 87 
\at{\IIb}{landfair} % 88
\at{\IIc}{northshield} % 89
\at{\IId}{ratliff1} % 93

\session{Statistics IIa}{STE 104}{To be announced}
\at{\IIa}{escobar} % 101
\at{\IIb}{hurlbut} % 102
\at{\IIc}{amerman} % 104
\at{\IId}{martinez} % 108

\session{Statistics IIb}{STE 102}{To be announced}
\at{\IIa}{darrow} % 99
...
\session{Applied Math IIIa}{STE 102}{To be announced}
\at{\IIIa}{field} % 19
\at{\IIIb}{curtin} % 18
\at{\IIIc}{turner} % 14

\session{Applied Math IIIb}{JEM 378}{To be announced}
\at{\IIIa}{wood} % 16
\at{\IIIb}{johnston} % 21
% \at{\IIIc}{}

\session{Combinatorics III}{JEM 362}{To be announced}
\at{\IIIa}{barde}  % 34
\at{\IIIb}{armstrong}  % 35
\at{\IIIc}{hernandez} % 37

\session{Differential Equations III}{JEM 166}{To be announced}
\at{\IIIa}{lefevre} % 48
\at{\IIIb}{oitsik} % 50
\at{\IIIc}{bennett} % 53

\session{Fractals and Chaos}{JEM 377}{To be announced}
\at{\IIIa}{healy} % 55
\at{\IIIb}{ostby} % 56
% \at{\IIIc}{}

\session{History of Mathematics}{JEM 281}{To be announced}
\at{\IIIa}{hemingway} % 71
\at{\IIIb}{marinoff} % 69
\at{\IIIc}{gingrich} % 70

\session{Knot Theory}{JEM 389}{To be announced}
\at{\IIIa}{lowrance} % 74
\at{\IIIb}{bennett} % 73
\at{\IIIc}{westland} % 72
...
\session{Number Theory III}{JEM 364}{To be announced}
\at{\IIIa}{wyler} % 85
\at{\IIIb}{covey} % 90
\at{\IIIc}{nasser} % 84

\session{Probability and Statistics}{JEM 168}{To be announced}
\at{\IIIa}{bianco} % 95
\at{\IIIb}{mao} % 107
\at{\IIIc}{fredericks} % 105

\session{Statistics III}{STE 104}{To be announced}
\at{\IIIa}{qi} % 98 
\at{\IIIb}{liu} % 97
\at{\IIIc}{davis} % 110

\session{Tropical Mathematics}{JEM 380}{To be announced}
\at{\IIIa}{cheverie} % 3
\at{\IIIb}{hamelin} % 29
\at{\IIIc}{lee} % boris
